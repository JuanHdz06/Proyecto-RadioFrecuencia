...
Public Class Form1
    ...
    Private Sub lfAgregarItem(ByVal pstrTag As String)
        ...
        Try
            My.Computer.Audio.Play(Strings.Trim(txtRuta.Text) & Strings.Trim(tag) & ".wav")
    ...
    Private Sub cmdFirmware_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFirmware.Click
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lblTotal.Text = 0
        txtRuta.Text = GetSetting(cstAplicacion, cstGeneral, cstRuta, "C:\ACCSYS-3000\VOX\")
    End Sub
...
Errores:
    ...
    Private Sub txtRuta_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtRuta.TextChanged
        Call SaveSetting(cstAplicacion, cstGeneral, cstRuta, txtRuta.Text)
    End Sub
