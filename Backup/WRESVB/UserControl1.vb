...
Public Class UserControl1
    ...
    'Funcion para leer el firmware
    '**********************************************************************************************
    Public Sub pfConectar(ByVal pbolSerial As Boolean, Optional ByVal pintPuertoCOM As String = "COM1", Optional ByVal pintPuerto As Integer = 10001, Optional ByVal pstrIP As String = "10.1.3.3")
